...
По умолчанию в контейнере устанавливается берлинское время. Если есть необходимость поменять, укажите желаемый часовой пояс в переменной TIME_ZONE.[Тётя Вика вам в помощь.](https://en.wikipedia.org/wiki/List_of_tz_database_time_zones#List)
